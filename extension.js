            ...
            type: 'exact', // Specify if it can accept variables or not (if so, these have to be handled yourself through the chat.message
              functionality: function (chat, cmd) {
                ...
                if (!bot.commands.executable(this.rank, chat)) return void (0);
                  ...
                  API.sendChat("/me 1. Mark Valentine: 50535 bodů, 2. Enciánová Predkožka 7853 bodů, 3. Derp: 6247 bodů");
        ...
        bot.commands.cleartokensCommand = {
            ...
            functionality: function (chat, cmd) {
                ...
                if (!bot.commands.executable(this.rank, chat)) return void (0);
                    ...
                    localStorage.setItem("Enciánová Predkožka", "7853");
                    localStorage.setItem("GΣИΣRΔTIOИ XIII.", "50535");
